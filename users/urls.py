...
urlpatterns = [
  ...
  path("my-profile/urls", views.MyUrls.as_view()),
  path("my-profile/moims/leader", views.MyMoimAsLeader.as_view()),
  path("my-profile/moims/crew", views.MyMoimAsCrew.as_view()),
  path("my-profile/moims/owner", views.MyMoimAsOwner.as_view()),
